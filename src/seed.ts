...
const seedRows: SeedRow[] = [
  {
    ...
    cells: {
      ...
      marketingFocal: ['Rev AI', 'CRO enablement (Uriya)', 'Comms / PR'],
      productFocal: ['EWM'],
  ...
  },
  {
    ...
    cells: {
      ...
      marketingFocal: ['Lifecycle', 'Existing customers / CCO'],
  ...
  },
  {
    ...
    cells: {
      ...
      marketingFocal: ['Regional mkt', 'SLG squad (Shai masot)'],
  ...
  },
  {
    ...
    cells: {
      ...
      marketingFocal: ['Enablement & GTM', 'Acquisition (leads)'],
  ...
  },
  {
    ...
    cells: {
      ...
      marketingFocal: ['Enablement (field)'],
      agenticFlow: ['TBD'],
    },
  },
  {
  ...
  },
  {
    ...
    cells: {
      ...
      persona: ['Champions'],
      marketingFocal: ['PR & comms', 'Social'],
  ...
  },
  {
    ...
    cells: {
      ...
      marketingFocal: ['Brand', 'Acquisition'],
